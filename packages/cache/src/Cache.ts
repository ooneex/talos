...
// biome-ignore lint/complexity/noStaticOnlyClass: Cache is the namespace for the cache key helpers
export class Cache {
  /**
   ...
   */
  public static keyFromRoute(prefix: string, method: string, url: string, userId?: string): string {
   ...
   */
  public static keyFromSocketRoute(
    prefix: string,
    routeName: string,
    userId?: string,
