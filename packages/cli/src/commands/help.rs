...
const COMMANDS: &[(&str, &str)] = &[
    ...
    (
        "project:check",
        "Run every health check: workspace, structure, tsconfig, lockfile, conventions, imports, registration, routes, entities, complexity, orphans, env, dependencies, docker, migrations, a11y, translations, stories, sdk, tests, docs, bundle, security, secrets, git, issues, commits, hygiene",
    ),
