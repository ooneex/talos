...
use super::{
    ...
    assets, asynchrony, audit, boundaries, branches, bundle, cache,
    commits::check_commits,
    complexity, container, contrast, conventions, crons, dedupe, dependencies, docker, docs,
    duplication, e2e_coverage, entities, env, events, exceptions, flags, folders, git, harden,
    health,
...
fn dispatch(args: &ProjectCheckArgs, root: &Path, id: CheckId) -> CheckOutcome {
    match id {
        ...
        CheckId::Dedupe => dedupe::run(root),
        ...
        CheckId::Performance => check_performance(args, root),
        ...
        CheckId::Audit => audit::run(args, root),
