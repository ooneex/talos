---
name: talos-module
description: Backend module layout and foundational patterns for this codebase — the module directory structure plus the dependency-injection, exception, and TypeScript conventions with code examples. Use when creating or navigating a module, or when wiring DI or exceptions.
...
For front-end modules, see the `talos-design` (design system) and `talos-spa` (single-page app) layouts. For typed config access, see `talos-env`.
