...
describe("@talosjs/cli - index", () => {
  const expectedCommands = [
    ...
    "GithubSecretPushCommand",
    "GitlabCredentialsCreateCommand",
    "GitlabSecretPushCommand",
    "BitbucketCredentialsCreateCommand",
    "BitbucketSecretPushCommand",
