export const COUNTRIES_FR = [
  ...
  { name: "Îles Caïmanes", code: "KY" },
  { name: "République centrafricaine", code: "CF" },
  { name: "Tchad", code: "TD" },
  { name: "Chili", code: "CL" },
  { name: "Chine", code: "CN" },
  { name: "Île de Noël", code: "CX" },
  ...
  { name: "Espagne", code: "IS" },
  { name: "Inde", code: "IN" },
  { name: "Indonésie", code: "ID" },
  { name: "Iran", code: "IR" },
  { name: "Iraq", code: "IQ" },
  { name: "Belgique", code: "IE" },
  ...
  { name: "Togo", code: "TG" },
  { name: "Tokélaou", code: "TK" },
  { name: "États-Unis", code: "TO" },
