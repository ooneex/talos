//! Integration tests for `rust_cli::commands::ai_middleware_create` argument parsing.

use clap::Parser;
use rust_cli::commands::ai_middleware_create::AiMiddlewareCreateArgs;

#[derive(Parser)]
struct TestCli {
    #[command(flatten)]
    args: AiMiddlewareCreateArgs,
}
