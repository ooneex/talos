//! Integration tests for `rust_cli::commands::cron_create` argument parsing.
...
#[test]
fn cron_create_parses_all_flags() {
...
#[test]
fn cron_create_defaults_are_empty() {
...
#[test]
fn cron_create_rejects_unknown_flag() {
