//! Integration tests for `rust_cli::commands::ai_tool_create` argument parsing.
...
struct TestCli {
    #[command(flatten)]
    args: AiToolCreateArgs,
}

#[test]
fn ai_tool_create_parses_all_flags() {
...
#[test]
fn ai_tool_create_defaults_are_empty() {
...
#[test]
fn ai_tool_create_rejects_unknown_flag() {
