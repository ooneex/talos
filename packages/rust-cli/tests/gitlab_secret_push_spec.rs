//! Integration tests for `rust_cli::commands::gitlab_secret_push` argument parsing.
...
struct TestCli {
    #[command(flatten)]
    args: GitlabSecretPushArgs,
}

#[test]
fn gitlab_secret_push_parses_all_flags() {
...
#[test]
fn gitlab_secret_push_defaults_are_empty() {
...
#[test]
fn gitlab_secret_push_rejects_unknown_flag() {
