...
describe("colorize", () => {
  ...
  test("should preserve the visible text", () => {
    expect(visibleWidth(colorize("0001", COLORS.success))).toBe("0001".length);
    expect(colorize("0001", COLORS.success)).toContain("0001");
  });
...
describe("SYMBOLS", () => {
  test("should expose one glyph per migration outcome", () => {
